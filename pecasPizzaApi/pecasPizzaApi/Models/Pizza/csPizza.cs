...
namespace pecasPizzaApi.Models.Pizza
{
    ...
    {
        public responsePizza insertarPizza(string nombrePizza, string descp_pizza, double precio) // Se creó una clase de tipo responsePizza para devolver la respuesta del servicio (devuelve 2 valores)
        {
            ...
            try
            {
                ...
                string cadena = "INSERT INTO Pizza(nombre_pizza, descp_pizza, precio) values " +
                    "('" + nombrePizza + "', '" + descp_pizza + "', " + precio + ")"; // Sentencia SQL para insertar una nueva pizza en la tabla Pizza
